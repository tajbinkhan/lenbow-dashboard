	...
	"min-h-5 gap-1 rounded-4xl border border-transparent px-2.5 py-0.5 text-[0.78rem] leading-none font-semibold antialiased transition-all has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&>svg]:size-3! inline-flex items-center justify-center w-fit whitespace-nowrap shrink-0 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-colors overflow-hidden group/badge",
	{
		variants: {
			variant: {
				...
				outline:
					"border-border/80 text-foreground bg-background/50 [a]:hover:bg-muted [a]:hover:text-foreground",
