...
import DataTableCompleteRepaySelected from "@/templates/Desktop/Borrow/Table/Components/DataTableCompleteRepaySelected";
		...
		<>
			<div className="flex items-center justify-between">
				...
				<div className="flex items-center gap-2">
					...
					{tableData.length > 0 && (
						<DataTableCompleteRepaySelected
							selectedIds={selectedIds}
							isCompletingRepay={isCompletingRepay}
							handleCompleteRepaySelected={handleCompleteRepaySelected}
						/>
					)}
